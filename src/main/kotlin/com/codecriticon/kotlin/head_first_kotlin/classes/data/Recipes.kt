...
fun main() {
    var r1 = Recipe("Thai Currry", "Chicken")
    var r2 = Recipe(title ="Thai Currry", mainIngredient = "Chicken")
    var r3 = r2.copy(title = "Chicken Bhuna")
    ...
    println("title is $title and vegetarion is $vegetarian")
